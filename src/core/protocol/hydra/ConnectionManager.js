    ...
    */
    ConnectionManager.prototype._setupListeners = function () {
        ...
        this._protocolConnectionManager.on('hydraMessage', function (identifier, ip, message) {
            ...
            if (msgToEmit) {
                logger.log('hydraReaction', 'Message Received', { type: msgToEmit.getMessageType(), circuitId: msgToEmit.getCircuitId(), socketIdent: identifier, circuitNodes: JSON.stringify(_this._circuitNodes) });
