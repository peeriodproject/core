...
var HydraCircuitFactory = (function () {
    function HydraCircuitFactory(hydraConfig, routingTable, connectionManager, messageCenter, circuitExtenderFactory, layeredEncDecHandlerFactory) {
        /**
    ...
    HydraCircuitFactory.prototype.create = function (numOfRelayNodes) {
        var nodePicker = new NodePicker(this._hydraConfig, numOfRelayNodes, this._routingTable);
