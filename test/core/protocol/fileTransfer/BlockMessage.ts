...
import ReadableBlockMessage = require('../../../../src/core/protocol/fileTransfer/share/messages/ReadableBlockMessage');
...
describe('CORE --> PROTOCOL --> FILE TRANSFER --> BlockMessage (readable and writable)', function () {
	...
	it('should correctly construct and deformat the BLOCK message', function () {
		...
		var buf:Buffer = factory.constructMessage(feedingNodesBlock, 123567, 'cafebabecafebabecafebabecafebabe', new Buffer('foobar'));
