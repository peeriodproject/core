...
import ReadableBlockRequestMessage = require('../../../../src/core/protocol/fileTransfer/share/messages/ReadableBlockRequestMessage');
...
describe('CORE --> PROTOCOL --> FILE TRANSFER --> BlockRequestMessage (readable and writable)', function () {
	...
	it('should correctly construct and deformat the a BLOCK_REQUEST message', function () {
		...
		var buf:Buffer = factory.constructMessage(feedingNodesBlock, 102456, 'cafebabecafebabecafebabecafebabe');
