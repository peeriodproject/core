...
var FoundClosestNodeReadableMessage = require('../../../src/core/protocol/findClosestNodes/messages/FoundClosestNodesReadableMessage');
...
describe('CORE --> PROTOCOL --> FIND CLOSEST NODES --> FoundClosestNodesReadableMessage @current', function () {
    ...
    var createWorkingMessage = function () {
        ...
        // 113626caca6c84fa4e5d323b6a26b897582c57e7
        var node2Id = new Buffer([0x11, 0x36, 0x26, 0xca, 0xca, 0x6c, 0x84, 0xfa, 0x4e, 0x5d, 0x32, 0x3b, 0x6a, 0x26, 0xb8, 0x97, 0x58, 0x2c, 0x57, 0xe7]);
        ...
        return Buffer.concat([searchForNodeId, delimiter, node1Id, node1Addresses, delimiter, node2Id, node2Addresses]);
    };

    it('should correctly deformat a message', function () {
        var msg = new FoundClosestNodeReadableMessage(createWorkingMessage(), nodeFactory, addressFactory);
        ...
        nodeList[1].getId().toHexString().should.equal('113626caca6c84fa4e5d323b6a26b897582c57e7');
